...
public class OcorrenciaTableModel extends AbstractTableModel {
    ...
    private final String[] columnNames = {"ID", "LOCAL", "DATA", "DESCRI��O"};
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            default:
                System.out.println("Coluna n�o encontrada ou n�o editavel!");
                break;
        }
    }
